// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GestureLeft2.cs" company="PG BullsEye">
//   Author: Daniela Betzl
// </copyright>
// <summary>
//   The gesture interaction technique to move the plate two steps to the left in the towers of hanoi game.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
/// The gesture interaction technique to move the plate two steps to the left in the towers of hanoi game.
/// </summary>
public class GestureLeft2 : MonoBehaviour, IGestureInteractionTechnique
{
    ...
    {
        Debug.Log("Gesture 'Two Steps Left' activated");
        this.toh.MovePlate(TowerOfHanoiGame.DirectionLeft, TowerOfHanoiGame.StepTwo);
    }
}