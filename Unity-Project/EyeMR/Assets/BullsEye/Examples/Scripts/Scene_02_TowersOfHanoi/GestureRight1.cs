// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GestureRight1.cs" company="PG BullsEye">
//   Author: Daniela Betzl
// </copyright>
// <summary>
//   The gesture interaction technique to move the plate one step to the right in the towers of hanoi game.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
/// The gesture interaction technique to move the plate one step to the right in the towers of hanoi game.
/// </summary>
public class GestureRight1 : MonoBehaviour, IGestureInteractionTechnique
{
    ...
    public void Start()
    {
        ...
        this.gesture =
            new GestureDetectionService.Gesture(
                new[] { 1.0f, 0.9f}, //1.1f, 1.0f }, 
                new[] { 270.0f, 180.0f}); //, 180.0f });
    }
    ...
    {
        Debug.Log("Gesture 'One Step Right' activated");
        this.toh.MovePlate(TowerOfHanoiGame.DirectionRight, TowerOfHanoiGame.StepOne);
    }
}