// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GestureLeft1.cs" company="PG BullsEye">
//   Author: Daniela Betzl
// </copyright>
// <summary>
//   The gesture interaction technique to move the plate one step to the left in the towers of hanoi game.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
/// The gesture interaction technique to move the plate one step to the left in the towers of hanoi game.
/// </summary>
public class GestureLeft1 : MonoBehaviour, IGestureInteractionTechnique
{
    ...
    {
        Debug.Log("Gesture 'One Step Left' activated");
        this.toh.MovePlate(TowerOfHanoiGame.DirectionLeft, TowerOfHanoiGame.StepOne);
    }
}
